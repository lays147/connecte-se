...
function buildSelect(label: string, options: string[], value: string, onChange: (value: string) => void): HTMLElement {
  ...
  select.className =
    "appearance-none rounded-lg border border-brand-200 bg-white px-3 py-2.5 font-body text-sm font-medium text-brand-950 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400";
